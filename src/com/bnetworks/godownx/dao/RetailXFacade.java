...
public class RetailXFacade
{
    ...
    public static class Implementation extends DBFacade
    {
        ...
        public DBResults search( Connection con , String table , String whereClause , String[] dataColumns ) throws SQLException
        {
            ...
            q.setOrderByClause("id desc");
            return search( con , q );
        }

        Implementation()
        {
            super("org.postgresql.Driver" , "jdbc:postgresql://localhost:5432/retailx" , "postgres" , "Rolta123");
        }
        public long insertAndGetID( String table , Map data , String idColumnName ) throws SQLException
        {
            ...
            data.put( '+' + idColumnName , "nextval( '" + table + "_"+ idColumnName + "_seq')" );
    ...
    {
        instance.doNotUseHighLowPattern();
        return instance ;
    }
