...
/** Strongly typed access to the database table "product_suppliers".
 *
 ...
 *
 */
public class Product_suppliersTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "product_suppliers";
    ...
    {
        idColumnName , product_idColumnName , supplier_idColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockProduct_suppliersTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( Product_suppliersTable.Implementation instance  )
    {
        imp = instance ;
    }
