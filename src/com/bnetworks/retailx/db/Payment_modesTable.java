...
/** Strongly typed access to the database table "payment_modes".
 *
 ...
 *
 */
public class Payment_modesTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "payment_modes";
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockPayment_modesTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( Payment_modesTable.Implementation instance  )
    {
        imp = instance ;
    }
