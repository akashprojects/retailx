...
/** Strongly typed access to the database table "bills".
 *
...
public class BillsTable
{
    ...
    public static final String bill_dateColumnName = "bill_date";
    public static final String discount_percentageColumnName = "discount_percentage";
    public static final String payment_modeColumnName = "payment_mode";
    public static final String counter_idColumnName = "counter_id";

    private static String[] allColumns =
    {
        idColumnName , bill_dateColumnName , discount_percentageColumnName , payment_modeColumnName , counter_idColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockBillsTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( BillsTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private boolean discount_percentageNull = true ;
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.bill_date = data[1];
                this.discount_percentageNull = ( data[2] == null );
                this.discount_percentage = discount_percentageNull ? 0 : Str.toInt( data[2] );
                this.payment_mode =  Str.toInt( data[3] );
                this.counter_id =  Str.toInt( data[4] );
        ...
        public void setDiscount_percentage( int discount_percentage )
        {
            ...
            discount_percentageNull = false ;
        }

        public void setDiscount_percentage( Integer discount_percentage )
        {
            discount_percentageNull = ( discount_percentage == null );
            if ( discount_percentageNull )
            {
                this.discount_percentage = 0 ;
            }
            else
            {
                this.discount_percentage = discount_percentage.intValue() ;
            }
        }

        public boolean isDiscount_percentageNull()
        {
            return discount_percentageNull ;
        }

        public void setDiscount_percentageNull( boolean discount_percentageNull )
        {
            this.discount_percentageNull = discount_percentageNull ;
            if ( discount_percentageNull )
            {
        ...
        private Map buildDataMap()
        {
            ...
            data.put( bill_dateColumnName , this.bill_date );
            data.put( discount_percentageColumnName , this.discount_percentageNull ? null : String.valueOf( this.discount_percentage ) );
            data.put( payment_modeColumnName , String.valueOf(  this.payment_mode ) );
            data.put( counter_idColumnName , String.valueOf(  this.counter_id ) );
            return data ;
        }
