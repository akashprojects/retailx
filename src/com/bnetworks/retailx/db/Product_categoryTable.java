...
/** Strongly typed access to the database table "product_category".
 *
 ...
 *
 */
public class Product_categoryTable
{
    ...
    public static final String category_idColumnName = "category_id";

    private static String[] allColumns =
    {
        idColumnName , product_idColumnName , category_idColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockProduct_categoryTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( Product_categoryTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.category_id =  Str.toInt( data[2] );
        ...
        private Map buildDataMap()
        {
            ...
            data.put( category_idColumnName , String.valueOf(  this.category_id ) );
            return data ;
        }
