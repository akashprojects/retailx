...
/** Strongly typed access to the database table "counters".
 *
...
public class CountersTable
{
    ...
    public static final String tableName = "counters";
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockCountersTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( CountersTable.Implementation instance  )
    {
        imp = instance ;
    }
