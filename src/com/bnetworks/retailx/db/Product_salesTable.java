...
/** Strongly typed access to the database table "product_sales".
 *
 ...
 *
 */
public class Product_salesTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "product_sales";

    public static final String idColumnName = "id";
    public static final String product_idColumnName = "product_id";
    public static final String product_stock_idColumnName = "product_stock_id";
    public static final String bill_idColumnName = "bill_id";

    private static String[] allColumns =
    {
        idColumnName , product_idColumnName , product_stock_idColumnName , bill_idColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockProduct_salesTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( Product_salesTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private boolean product_idNull = true ;
        private int product_stock_id ;
        private boolean product_stock_idNull = true ;
        private int bill_id ;
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.product_idNull = ( data[1] == null );
                this.product_id = product_idNull ? 0 : Str.toInt( data[1] );
                this.product_stock_idNull = ( data[2] == null );
                this.product_stock_id = product_stock_idNull ? 0 : Str.toInt( data[2] );
                this.bill_id =  Str.toInt( data[3] );
        ...
        public void setProduct_id( int product_id )
        {
            ...
            product_idNull = false ;
        }

        public void setProduct_id( Integer product_id )
        {
            product_idNull = ( product_id == null );
            if ( product_idNull )
            {
                this.product_id = 0 ;
            }
        ...
        public boolean isProduct_idNull()
        {
            return product_idNull ;
        }

        public void setProduct_idNull( boolean product_idNull )
        {
            this.product_idNull = product_idNull ;
            if ( product_idNull )
            {
                product_id = 0 ;
            }
        ...
        public int getProduct_stock_id()
        {
            return product_stock_id ;
        }

        public void setProduct_stock_id( int product_stock_id )
        {
            this.product_stock_id = product_stock_id ;
            product_stock_idNull = false ;
        }

        public void setProduct_stock_id( Integer product_stock_id )
        {
            product_stock_idNull = ( product_stock_id == null );
            if ( product_stock_idNull )
            {
                this.product_stock_id = 0 ;
            }
            else
            {
                this.product_stock_id = product_stock_id.intValue() ;
            }
        }

        public boolean isProduct_stock_idNull()
        {
            return product_stock_idNull ;
        }

        public void setProduct_stock_idNull( boolean product_stock_idNull )
        {
            this.product_stock_idNull = product_stock_idNull ;
            if ( product_stock_idNull )
            {
                product_stock_id = 0 ;
            }
        ...
        private Map buildDataMap()
        {
            ...
            data.put( product_idColumnName , this.product_idNull ? null : String.valueOf( this.product_id ) );
            data.put( product_stock_idColumnName , this.product_stock_idNull ? null : String.valueOf( this.product_stock_id ) );
            data.put( bill_idColumnName , String.valueOf(  this.bill_id ) );
            return data ;
        }
