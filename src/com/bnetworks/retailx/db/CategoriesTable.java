...
/** Strongly typed access to the database table "categories".
 *
...
public class CategoriesTable
{
    ...
    public static final String parent_category_idColumnName = "parent_category_id";
    public static final String default_supplier_idColumnName = "default_supplier_id";
    public static final String is_disabledColumnName = "is_disabled";

    private static String[] allColumns =
    {
        idColumnName , nameColumnName , parent_category_idColumnName , default_supplier_idColumnName , is_disabledColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockCategoriesTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( CategoriesTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private boolean is_disabledNull = true ;
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.name = data[1];
                this.parent_category_id =  Str.toInt( data[2] );
                this.default_supplier_idNull = ( data[3] == null );
                this.default_supplier_id = default_supplier_idNull ? 0 : Str.toInt( data[3] );
                this.is_disabledNull = ( data[4] == null );
                this.is_disabled = is_disabledNull ? 0 : Str.toInt( data[4] );
        ...
        public void setIs_disabled( int is_disabled )
        {
            ...
            is_disabledNull = false ;
        }

        public void setIs_disabled( Integer is_disabled )
        {
            is_disabledNull = ( is_disabled == null );
            if ( is_disabledNull )
            {
                this.is_disabled = 0 ;
            }
            ...
            {
                this.is_disabled = is_disabled.intValue() ;
            }
        }

        public boolean isIs_disabledNull()
        {
            return is_disabledNull ;
        }

        public void setIs_disabledNull( boolean is_disabledNull )
        {
            this.is_disabledNull = is_disabledNull ;
            if ( is_disabledNull )
            {
                is_disabled = 0 ;
            }
        ...
        private Map buildDataMap()
        {
            ...
            data.put( parent_category_idColumnName , String.valueOf(  this.parent_category_id ) );
            data.put( default_supplier_idColumnName , this.default_supplier_idNull ? null : String.valueOf( this.default_supplier_id ) );
            data.put( is_disabledColumnName , this.is_disabledNull ? null : String.valueOf( this.is_disabled ) );
            return data ;
        }
