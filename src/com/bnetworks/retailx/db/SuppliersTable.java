...
/** Strongly typed access to the database table "suppliers".
 *
...
public class SuppliersTable
{
    ...
    public static final String contact_numberColumnName = "contact_number";

    private static String[] allColumns =
    {
        idColumnName , nameColumnName , addressColumnName , contact_numberColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockSuppliersTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( SuppliersTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Map buildDataMap()
        {
            ...
            data.put( contact_numberColumnName , this.contact_number );
            return data ;
        }
